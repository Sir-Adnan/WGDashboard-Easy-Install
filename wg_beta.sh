...
# ==================================================
#   WGDASHBOARD MASTER v1.1 - The Ultimate UI
...
setup_backup_bot() {
    ...
    TEST=$(curl -s --max-time 10 -X POST "https://api.telegram.org/bot${TG_TOKEN}/sendMessage" -d chat_id="${TG_CHATID}" -d text="🔌 Connection Verified by WGDashboard Manager v1.1")
