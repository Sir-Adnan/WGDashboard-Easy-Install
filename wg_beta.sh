...
# ==================================================
#   WGDASHBOARD MASTER v1.3 - The Ultimate UI
#   Visuals: Inspired by GRE Master (Cyberpunk)
#   Logic: V13 (Smart & Essential Backup Modes)
# ==================================================
...
setup_backup_bot() {
    ...
    TEST=$(curl -s --max-time 10 -X POST "https://api.telegram.org/bot${TG_TOKEN}/sendMessage" -d chat_id="${TG_CHATID}" -d text="🔌 Connection Verified by WGDashboard Manager v1.3")
